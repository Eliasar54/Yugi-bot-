...
const banner = cfonts.render((`YUGI-BOT |ELIASAR_YT`), {
font: 'tiny',             
align: 'center',           
...
const wm = "ELIASAR YT" // cambiar creador
const botname = "yugi bot" // Cambiar nombre del bot

const numerodono = "+82340051"; // cambiar número
...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
            ...
            console.log(color(`${themeemoji} ELIASAR_YT\n`,'magenta'))
		}
...
case "s" :
enviar("*el comando .s no esta disponible*")
break
